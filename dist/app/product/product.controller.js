...
exports.updateSingleProduct = exports.deleteSingleProduct = exports.getCategoriesProduct = exports.getSingleProduct = exports.getAllProducts = exports.createProduct = void 0;
...
const getCategoriesProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { category } = req.params;
    const products = yield (0, product_service_1.getProductByCategory)(category);
    res.status(200).json({
        status: 'success',
        data: products
    });
...
exports.getCategoriesProduct = getCategoriesProduct;
